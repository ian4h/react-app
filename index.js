...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_App2.default, { text: 'Props text' }), document.getElementById('app')); /**
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(Slider, { update: this.update }),
	                _react2.default.createElement(Slider, { update: this.update })
	            );
	        }
	    }]);
